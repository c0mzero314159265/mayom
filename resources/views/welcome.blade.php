                    ...
                    <div class="container-fluid">
                        ...
                        <div id="main-nav" class="stellarnav">
                            <div class="search-and-signup-button white pull-right hidden-md hidden-sm hidden-xs">
                                ...
                                @auth
                                <a href="{{ route('home') }}" class="sign-up">Home</a>
                                @else
                                <a href="{{ route('login') }}" class="sign-up">SignUp</a>
                                @endauth
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="white">
                                    <form action="#" class="search-form">
                                        <input type="search" name="search" id="search" class="search" placeholder="Search Here..">
                    ...
                    <div class="row flex-v-center">
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-mockup center">
                                <img src="img/home/iPhone X - Get_reward.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="screenshot-slider-area wow fadeIn">
                        <div class="screenshot-slider">
                            ...
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-2.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-3.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-4.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-5.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-6.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-7.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-8.png" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="img/screenshot/sc-2.png" alt="">
                            </div>
